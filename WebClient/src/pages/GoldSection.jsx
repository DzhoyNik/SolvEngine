    ...
    return (
        <div className="wrapper" style={{
            ...
            <div className="sidebar">
                <FillButtonBack />
                <h1 style={{ letterSpacing: "0.35rem" }}>Метод Золотого Сечения</h1>
                <div className="sidebar-body">
                    ...
                    <div className="sidebar-section">
                        ...
                        <div style={{
                            ...
                            <h2>Ищем максимум?*</h2>
                            <input type="checkbox" value={isMaximum} onChange={ e => setIsMaximum(e.target.checked) } style={{
